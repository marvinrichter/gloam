...
Amethyst is the only theme in the clarc-starship set where purple is the primary navigation color. Every other theme uses purple as chrome or accent — something secondary, receding. Here purple leads.
...
clarc-starship/
└── amethyst/
    ├── amethyst.toml         starship prompt configuration
    ├── Amethyst.itermcolors  iTerm2 color theme (plist)
...
# 2. Prompt
cp amethyst.toml ~/.config/starship.toml

# 3. iTerm2 theme
#    Preferences › Profiles › Colors › Color Presets › Import › Amethyst.itermcolors
#    Then select "Amethyst" from the preset list
