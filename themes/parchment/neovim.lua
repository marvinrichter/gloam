...
-- ── Base groups ──────────────────────────────────────────────────────────────
  vim.api.nvim_set_hl(0, "Normal", { bg = "#E8D6B4", fg = "#2A1E12" })
  vim.api.nvim_set_hl(0, "NormalFloat", { bg = "#4A3828", fg = "#2A1E12" })
  vim.api.nvim_set_hl(0, "NormalNC", { bg = "#E8D6B4", fg = "#6B5A48" })
  vim.api.nvim_set_hl(0, "Visual", { bg = "#D4BEA0", fg = "#2A1E12" })
  ...
  vim.api.nvim_set_hl(0, "SignColumn", { bg = "#E8D6B4" })
  vim.api.nvim_set_hl(0, "ColorColumn", { bg = "#4A3828" })
  vim.api.nvim_set_hl(0, "StatusLine", { bg = "#4A3828", fg = "#2A1E12" })
  vim.api.nvim_set_hl(0, "StatusLineNC", { bg = "#E8D6B4", fg = "#6B5A48" })
  vim.api.nvim_set_hl(0, "VertSplit", { fg = "#6B5A48" })
  vim.api.nvim_set_hl(0, "Pmenu", { bg = "#4A3828", fg = "#2A1E12" })
  vim.api.nvim_set_hl(0, "PmenuSel", { bg = "#D4BEA0", fg = "#2A1E12" })
  vim.api.nvim_set_hl(0, "PmenuSbar", { bg = "#4A3828" })
  vim.api.nvim_set_hl(0, "PmenuThumb", { bg = "#6B5A48" })
  vim.api.nvim_set_hl(0, "Search", { bg = "#7A3A10", fg = "#E8D6B4" })
  vim.api.nvim_set_hl(0, "IncSearch", { bg = "#4A2E12", fg = "#E8D6B4" })
  vim.api.nvim_set_hl(0, "MatchParen", { bg = "#7A3A10", fg = "#E8D6B4", bold = true })
  ...
  vim.api.nvim_set_hl(0, "FoldColumn", { bg = "#E8D6B4", fg = "#6B5A48" })
  vim.api.nvim_set_hl(0, "WildMenu", { bg = "#7A3A10", fg = "#E8D6B4" })
...
-- ── Syntax groups ───────────────────────────────────────────────────────────
  ...
  vim.api.nvim_set_hl(0, "Todo", { bg = "#7A3A10", fg = "#E8D6B4", bold = true })
