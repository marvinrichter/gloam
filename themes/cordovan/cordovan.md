...
clarc-starship/
└── cordovan/
    ├── cordovan.toml          starship prompt configuration
    ├── Cordovan.itermcolors   iTerm2 color theme (plist)
    └── CORDOVAN.md            this file
```
...
# 2. Prompt
cp cordovan.toml ~/.config/starship.toml

# 3. iTerm2 theme
#    Preferences › Profiles › Colors › Color Presets › Import › Cordovan.itermcolors
#    Then select "Cordovan" from the preset list
