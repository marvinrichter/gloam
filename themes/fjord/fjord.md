...
```
clarc-starship/fjord/
├── fjord.toml          starship prompt configuration
├── Fjord.itermcolors   iTerm2 color theme (plist)
...
# 2. Prompt
cp fjord.toml ~/.config/starship.toml

# 3. iTerm2 theme
#    Preferences › Profiles › Colors › Color Presets › Import › Fjord.itermcolors
#    Then select "Fjord" from the preset list
