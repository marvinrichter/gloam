...
```
clarc-starship/
├── eventide.toml          starship prompt configuration
└── Eventide.itermcolors   iTerm2 color theme (plist)
```
...
# 2. Prompt
cp eventide.toml ~/.config/starship.toml

# 3. iTerm2 theme
#    Preferences › Profiles › Colors › Color Presets › Import › Eventide.itermcolors
#    Then select "Eventide" from the preset list
